...
public class StrategiaOttimizzazioneLitriTest {
    ...
    public void testOttimizzaConAttrezziDisponibili() {
        ...
        Attrezzo bollitorePiccolo = new Attrezzo("bollitorePiccolo", TipoAttrezzo.BOLLITORE, 4.0);
        Attrezzo fermentatorePiccolo = new Attrezzo("fermentatorePiccolo", TipoAttrezzo.FERMENTATORE, 8.0);
        Attrezzo distillatorePiccolo = new Attrezzo("distillatorePiccolo", TipoAttrezzo.DISTILLATORE, 12.0);
